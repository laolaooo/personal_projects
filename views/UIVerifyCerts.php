    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Verify Certificates</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Verify Certificates</h5>
                <p>Welcome to the Certificate Verification page. Here, administrators can verify the authenticity and details of issued certificates. Utilize the table below to review and manage certificate information efficiently.</p>
